...
const Portfolio = () => {
	...
	return (
		<section className="portfolio container section" id="portfolio">
			<h2 className="section__title">پروژه های اخیر</h2>
			...
			<div className="portfolio__filters">
				...
				<span className={activeFilter === 2 ? 'portfolio__item portfolio__item-active' : 'portfolio__item'} onClick={() => { filterItems("AI"); setActiveFilter(2) }}>
					AI
				</span>
