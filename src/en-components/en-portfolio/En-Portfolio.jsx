...
const EnPortfolio = () => {
	const [items, setItems] = useState(EnMenu);
	const [activeFilter, setActiveFilter] = useState(0);
	const filterItems = (categoryItem) => {
		const updatedItems = EnMenu.filter((curElem) => {
	...
	return (
		<section className="portfolio container section" id="portfolio">
			...
			<div className="portfolio__filters">
				<span className={activeFilter === 0 ? 'portfolio__item portfolio__item-active' : 'portfolio__item'} onClick={() => { setItems(EnMenu); setActiveFilter(0) }}>
					All
				</span>
